namespace Freedom_Planet_2_Archipelago.Patchers
{
    internal class MenuArenaChallengeSelectPatcher
    {
        ...
        static void GetChallengeRewardSprites()
        {
            ...
            [
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Beginner's Gauntlet"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Battlebot Battle Royale"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Hero Battle Royale"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Kalaw's Challenge"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Army of One"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Ring-Out Challenge"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Flip Fire Gauntlet"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Vanishing Maze"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Mondo Condo"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Birds of Prey"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Battlebot Revenge"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Mach Speed Melee"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Galactic Rumble"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Stop and Go"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Mecha Madness"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Rolling Thunder"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Blast from the Past"),
                Plugin.session.Locations.GetLocationIdFromName("Freedom Planet 2", "Bubble Battle"),
            ];
